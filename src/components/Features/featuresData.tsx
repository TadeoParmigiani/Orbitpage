...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="7" height="18" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/></svg>
    ),
    title: "Apps Web a Medida",
    paragraph:
      "Desarrollamos aplicaciones web adaptadas a las necesidades específicas de tu negocio, garantizando funcionalidad, seguridad y escalabilidad.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Landing Pages",
    paragraph:
      "Creamos landing pages optimizadas para captar clientes, mejorar conversiones y fortalecer la presencia digital de tu marca.",
  },
  {
    id: 3,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" ><path d="M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-5Zm0 0a9 9 0 1 1 18 0m0 0v5a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3Z"/><path d="M21 16v2a4 4 0 0 1-4 4h-5"/></svg>
    ),
    title: "Soporte Técnico Personalizado",
    paragraph:
      "Brindamos asistencia especializada, resolviendo problemas técnicos y asegurando el óptimo funcionamiento de nuestros sistemas.",
  },
  {
    id: 4,
    icon: (
    ...
    paragraph:
      "Diseñamos y desarrollamos plataformas SaaS escalables, permitiéndote ofrecer servicios en la nube con tecnología de vanguardia.",
  },
  {
    id: 5,
    icon: (
    ...
    paragraph:
      "Nos encargamos del mantenimiento continuo y la optimización de tus plataformas para mejorar su rendimiento y seguridad.",
  },
  {
    id: 6,
    icon: (
    ...
    paragraph:
      "Te asesoramos en la elección de tecnologías, metodologías y estrategias digitales para que tu negocio aproveche al máximo su potencial.",
  },
];
